// <copyright file="KrovakModifiedNorthOrientedProjectionTest.cs" company="Eötvös Loránd University (ELTE)">
...
namespace ELTE.AEGIS.Tests.Reference.Collections.Formula
{
    ...
    /// <summary>
    /// Test fixture for the <see cref="KrovakModifiedNorthOrientedProjection" /> class.
    /// </summary>
    [TestFixture]
    public class KrovakModifiedNorthOrientedProjectionTest
    {
        /// <summary>
        /// The projection.
        /// </summary>
        private KrovakModifiedNorthOrientedProjection projection;
        ...
        public void SetUp()
        {
            ...
            this.projection = new KrovakModifiedNorthOrientedProjection("EPSG::5225", " S-JTSK/05 (Ferro) / Modified Krovak East North", parameters, ellipsoid, areaOfUse);
        }
