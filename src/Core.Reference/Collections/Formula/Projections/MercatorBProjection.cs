...
namespace AEGIS.Reference.Collections.Formula
{
    ...
    public class MercatorBProjection : MercatorProjection
    {
        ...
        /// </exception>
        public MercatorBProjection(String identifier, String name, IDictionary<CoordinateOperationParameter, Object> parameters, Ellipsoid ellipsoid, AreaOfUse areaOfUse)
        ...
        /// The area of use is null.
        /// </exception>
        public MercatorBProjection(String identifier, String name, String remarks, String[] aliases, IDictionary<CoordinateOperationParameter, Object> parameters, Ellipsoid ellipsoid, AreaOfUse areaOfUse)
            : base(identifier, name, remarks, aliases, CoordinateOperationMethods.MercatorBProjection, parameters, ellipsoid, areaOfUse)
        {
