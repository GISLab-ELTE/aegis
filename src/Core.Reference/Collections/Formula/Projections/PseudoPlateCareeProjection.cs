...
namespace AEGIS.Reference.Collections.Formula
{
    ...
    public class PseudoPlateCareeProjection : CoordinateProjection
    {
        ...
        /// </exception>
        public PseudoPlateCareeProjection(String identifier, String name, IDictionary<CoordinateOperationParameter, Object> parameters, Ellipsoid ellipsoid, AreaOfUse areaOfUse)
        ...
        /// The area of use is null.
        /// </exception>
        public PseudoPlateCareeProjection(String identifier, String name, String remarks, String[] aliases, IDictionary<CoordinateOperationParameter, Object> parameters, Ellipsoid ellipsoid, AreaOfUse areaOfUse)
            : base(identifier, name, remarks, aliases, CoordinateOperationMethods.PseudoPlateCareeProjection, parameters, ellipsoid, areaOfUse)
        {
        }
