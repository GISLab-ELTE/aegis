...
namespace AEGIS.Reference.Collections.Formula
{
    ...
    public class KrovakNorthOrientedProjection : KrovakProjection
    {
        ...
        /// </exception>
        public KrovakNorthOrientedProjection(String identifier, String name, IDictionary<CoordinateOperationParameter, Object> parameters, Ellipsoid ellipsoid, AreaOfUse areaOfUse)
        ...
        /// The area of use is null.
        /// </exception>
        public KrovakNorthOrientedProjection(String identifier, String name, String remarks, String[] aliases, IDictionary<CoordinateOperationParameter, Object> parameters, Ellipsoid ellipsoid, AreaOfUse areaOfUse)
            : base(identifier, name, remarks, aliases, CoordinateOperationMethods.KrovakNorthOrientedProjection, parameters, ellipsoid, areaOfUse)
        {
        }
