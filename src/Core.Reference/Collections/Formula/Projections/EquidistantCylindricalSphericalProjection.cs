...
namespace ELTE.AEGIS.Reference.Collections.Formula
{
    ...
    public class EquidistantCylindricalSphericalProjection : EquidistantCylindricalProjection
    {
        ...
        /// </exception>
        public EquidistantCylindricalSphericalProjection(String identifier, String name, IDictionary<CoordinateOperationParameter, Object> parameters, Ellipsoid ellipsoid, AreaOfUse areaOfUse)
        ...
        /// The area of use is null.
        /// </exception>
        public EquidistantCylindricalSphericalProjection(String identifier, String name, String remarks, String[] aliases, IDictionary<CoordinateOperationParameter, Object> parameters, Ellipsoid ellipsoid, AreaOfUse areaOfUse)
