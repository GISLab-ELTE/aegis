...
namespace AEGIS.Reference.Collections.Formula
{
    ...
    public class MercatorAProjection : MercatorProjection
    {
        ...
        /// </exception>
        public MercatorAProjection(String identifier, String name, IDictionary<CoordinateOperationParameter, Object> parameters, Ellipsoid ellipsoid, AreaOfUse areaOfUse)
        ...
        /// The area of use is null.
        /// </exception>
        public MercatorAProjection(String identifier, String name, String remarks, String[] aliases, IDictionary<CoordinateOperationParameter, Object> parameters, Ellipsoid ellipsoid, AreaOfUse areaOfUse)
            : base(identifier, name, remarks, aliases, CoordinateOperationMethods.MercatorAProjection, parameters, ellipsoid, areaOfUse)
        {
