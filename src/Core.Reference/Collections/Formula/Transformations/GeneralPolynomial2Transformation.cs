// <copyright file="GeneralPolynomial2Transformation.cs" company="Eötvös Loránd University (ELTE)">
...
namespace ELTE.AEGIS.Reference.Collections.Formula
{
    ...
    /// <summary>
    /// Represents a General polynomial transformation of degree 2.
    /// </summary>
    ...
    public class GeneralPolynomial2Transformation : GeneralPolynomialTransformation
    {
        ...
        /// </exception>
        public GeneralPolynomial2Transformation(String identifier, String name, IDictionary<CoordinateOperationParameter, Object> parameters,
        ...
        /// The area of use is null.
        /// </exception>
        public GeneralPolynomial2Transformation(String identifier, String name, String remarks, String[] aliases, IDictionary<CoordinateOperationParameter, Object> parameters,
                                                CoordinateReferenceSystem source, CoordinateReferenceSystem target, AreaOfUse areaOfUse)
