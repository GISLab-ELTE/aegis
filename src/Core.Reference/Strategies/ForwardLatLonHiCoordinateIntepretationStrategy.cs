// <copyright file="ForwardLatLonHiCoordinateIntepretationStrategy.cs" company="Eötvös Loránd University (ELTE)">
...
namespace AEGIS.Reference.Strategies
{
    ...
    /// </summary>
    public class ForwardLatLonHiCoordinateIntepretationStrategy : ForwardLatLonCoordinateInterpretationStrategy
    {
        /// <summary>
        ...
        {
            return new Coordinate(coordinate.Latitude.GetValue(this.latitudeUnit), coordinate.Longitude.GetValue(this.longitudeUnit), coordinate.Height.GetValue(this.heightUnit));
        }
    }
}
