// <copyright file="ReverseLonLatCoordinateIntepretationStrategy.cs" company="Eötvös Loránd University (ELTE)">
...
namespace ELTE.AEGIS.Reference.Strategies
{
    ...
    /// <summary>
    /// Represents a reverse coordinate interpretation for (longitude, latitude) representation.
    /// </summary>
    public class ReverseLonLatCoordinateIntepretationStrategy : ICoordinateOperationStrategy<Coordinate, GeoCoordinate>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReverseLonLatCoordinateIntepretationStrategy" /> class.
        /// </summary>
        ...
        public ReverseLonLatCoordinateIntepretationStrategy(CoordinateReferenceSystem referenceSystem)
        {
            ...
            this.latitudeUnit = this.referenceSystem.CoordinateSystem.GetAxis(1).Unit;
        }
        ...
        public ReferenceSystem SourceReferenceSystem { get { return this.referenceSystem; } }

        /// <summary>
        /// Gets the target reference system.
        /// </summary>
        /// <value>The target reference system.</value>
        public ReferenceSystem TargetReferenceSystem { get { return this.referenceSystem; } }
        ...
        public virtual GeoCoordinate Apply(Coordinate coordinate)
        {
            return new GeoCoordinate(new Angle(coordinate.Y, this.latitudeUnit), new Angle(coordinate.X, this.longitudeUnit));
        }
    }
}
