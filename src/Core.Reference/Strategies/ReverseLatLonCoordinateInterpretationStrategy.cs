...
namespace ELTE.AEGIS.Reference.Strategies
{
    ...
    /// </summary>
    public class ReverseLatLonCoordinateInterpretationStrategy : ICoordinateOperationStrategy<Coordinate, GeoCoordinate>
    {
        /// <summary>
        ...
        {
            return new GeoCoordinate(new Angle(coordinate.X, this.latitudeUnit), new Angle(coordinate.Y, this.longitudeUnit));
        }
    }
}
