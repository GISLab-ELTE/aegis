// <copyright file="ForwardLonLatCoordinateIntepretationStrategy.cs" company="Eötvös Loránd University (ELTE)">
...
namespace ELTE.AEGIS.Reference.Strategies
{
    ...
    /// <summary>
    /// Represents a forward coordinate interpretation for (longitude, latitude) representation.
    /// </summary>
    public class ForwardLonLatCoordinateIntepretationStrategy : ICoordinateOperationStrategy<GeoCoordinate, Coordinate>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ForwardLonLatCoordinateIntepretationStrategy" /> class.
        /// </summary>
        ...
        {
            return new Coordinate(coordinate.Longitude.GetValue(this.longitudeUnit), coordinate.Latitude.GetValue(this.latitudeUnit));
        }
    }
}
