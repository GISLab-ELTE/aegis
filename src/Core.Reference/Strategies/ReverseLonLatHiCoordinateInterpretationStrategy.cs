// <copyright file="ReverseLonLatHiCoordinateInterpretationStrategy.cs" company="Eötvös Loránd University (ELTE)">
...
namespace AEGIS.Reference.Strategies
{
    ...
    /// <summary>
    /// Represents a reverse coordinate interpretation for (longitude, latitude, height) representation.
    /// </summary>
    public class ReverseLonLatHiCoordinateInterpretationStrategy : ReverseLonLatCoordinateIntepretationStrategy
    {
        /// <summary>
        ...
        {
            return new GeoCoordinate(new Angle(coordinate.Y, this.latitudeUnit), new Angle(coordinate.X, this.longitudeUnit), new Length(coordinate.Z, this.heightUnit));
        }
    }
}
